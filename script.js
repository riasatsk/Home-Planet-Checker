...
function random_planet() {
  ...
  document.getElementById(
    "planet"
  ).innerHTML = `Your home planet is <b>${myPlanet}</b> Let's Go to ${myPlanet}🚀👨‍🚀`;
  if (random_number == 0) {
    ...
    document.getElementById("details").src = "assets/venus.mp3";
    ...
    document.getElementById("details").src = "assets/earth.mp3";
    ...
    document.getElementById("details").src = "assets/mars.mp3";
    ...
    document.getElementById("details").src = "assets/saturn.mp3";
    ...
    document.getElementById("details").src = "assets/uranus.mp3";
    ...
    document.getElementById("details").src = "assets/neptune.mp3";
    ...
    document.getElementById("details").src = "assets/pluto.mp3";
